...
-- T-34
UPDATE Language_ru_RU
SET Text = 'Быстрые и мощные машины конца игры.[NEWLINE]Сильнее и подвижнее обычных танков.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_PANZER';

-- B-17
UPDATE Language_ru_RU
SET Text = 'Воздушный юнит, несущий смерть и разрушения городам, людям и технике. У него высокий шанс уклониться от перехватчиков. Кроме того он наносит более тяжёлый урон городам чем обычные бомбардировщики.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_B17';

-- Zero
UPDATE Language_ru_RU
SET Text = 'Истребитель для обеспечения господства в воздухе и перехвата вражеских самолётов. Он имеет бонус в сражениях с другими истребителями и не требует нефти, в отличии от стандартных.'
