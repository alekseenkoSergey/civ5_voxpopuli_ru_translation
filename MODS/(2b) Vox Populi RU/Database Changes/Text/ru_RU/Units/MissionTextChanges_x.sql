...
-- Repair Fleet
UPDATE Language_ru_RU
SET Text = 'Этот приказ расходует великого адмирала и лечит все ваши морские и погружённые юниты на этой клетке и на всех соседних клетках. Также увеличивает ваш [ICON_SILVER_FIST] лимит военного снабжения на 1.'
