...
UPDATE Language_ru_RU
SET Text = 'Минитмен очень силён, поскольку ему требуется на 50% меньше опыта, чтобы открыть повышение «Дальность», благодаря повышению «Залп I». В сочетании с игнорированием пересечённой местности это позволяет быстро расставлять множество минитменов и много раз атаковать города и юниты, оставаясь в безопасности от ответного дальнобойного огня. Старайтесь добивать ими вражеские юниты, чтобы получать очки Золотого века. Минитмены также превосходны в обороне: они могут отступать по пересечённой местности и стрелять в тот же ход.[NEWLINE][NEWLINE]Ветка повышений «Залп» настоятельно рекомендуется из-за лёгкого доступа к повышению «Дальность». Делайте минитменов ядром своей армии, в ущерб рукопашным и осадным юнитам.'
...
UPDATE Language_ru_RU
SET Text = 'Квинкверема обладает, пожалуй, самыми сильными повышениями среди кораблей классической и средневековой эпох — благодаря повышению «Клещи». Старайтесь как можно чаще окружать вражеские корабли, чтобы использовать усиленный фланговый бонус. Это будет несложно благодаря игнорированию зон контроля. В сочетании с более высокой боевой силой и бонусом +25% при атаке вражеские корабли не должны представлять проблемы. Точно так же поощряется атака городов, особенно до постройки Замка, благодаря бонусу +50% при атаке на них. Рекомендуется идти по ветке повышений «Абордаж», чтобы добраться до «Блица»: это позволит двигаться после атаки и, следовательно, атаковать город множеством кораблей за один ход. В качестве альтернативы хорошим выбором также будут повышения ветки «Корпус», ведущие к «Авангарду».'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Великое языческое войско'
...
UPDATE Language_ru_RU
SET Text = 'Корабль-черепаха обладает более мощной атакой, чем Каравелла, и чрезвычайно трудно уничтожается благодаря повышению «Несокрушимость». Однако, хотя он может заканчивать движение на океанских клетках, по ним он всё равно передвигается с половинной скоростью.'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Юниты-застрельщики начинают игру с повышениями [COLOR_POSITIVE_TEXT]Логистика[ENDCOLOR] и [COLOR_POSITIVE_TEXT]Великие генералы I[ENDCOLOR]. Когда вы [ICON_PIRATE] запугиваете город-государство, получаете мгновенный прирост [ICON_PRODUCTION] производства и [ICON_RESEARCH] науки в [ICON_CAPITAL] столице в размере 25% от полученного [ICON_GOLD] золота.'
...
UPDATE Language_ru_RU
SET Text = 'Баллиста — превосходное осадное орудие. Хотя она всё ещё очень полезна против городов, отсутствие штрафов против сухопутных юнитов и бесплатное повышение «Полевой бой I» дают ей дополнительную мощь против других юнитов. Баллиста всё ещё довольно уязвима для атак, так что обязательно прикрывайте её другими войсками. На вражеской территории движется с половинной скоростью, но имеет обычную дальность обзора.'
...
UPDATE Language_ru_RU
SET Text = 'Слон Наресуана очень силён в боях против рукопашных юнитов, поэтому используйте его прежде всего против них. Ставьте его рядом с теми вражескими юнитами, которых собираетесь атаковать другими войсками, чтобы повышение «Устрашающий слон» ослабляло цель для ваших прочих юнитов. Старайтесь держать великих генералов вместе со слонами Наресуана, чтобы использовать бонус к боевой силе.[NEWLINE][NEWLINE]Поскольку для него не требуются ресурсы лошадей, Слон Наресуана может заменить все ваши рукопашные юниты, которые в большинстве ситуаций слабее. Хотя 3 очка передвижения меньше стандартных 4 у конных юнитов, этого всё равно достаточно для хорошей гибкости и сосредоточенных атак, особенно с возможностью двигаться после атаки. Неиспользованных лошадей можно потратить на торговлю.'
...
UPDATE Language_ru_RU
SET Text = 'Великая галеасса действует похожим образом на обычную галеассу, но лучше выдерживает бой и обладает более сильной дальнобойной атакой. Начинает с повышением [COLOR_POSITIVE_TEXT]Бомбардировка I[ENDCOLOR].'
