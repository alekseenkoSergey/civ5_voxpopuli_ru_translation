...
UPDATE Language_ru_RU
SET Text = 'Их текущий союзник — {1_CivName:textkey}. Вам нужно ещё {2_NumInfluence} [ICON_INFLUENCE] влияния, чтобы превзойти {1_CivName:textkey} и стать их союзником.[NEWLINE][NEWLINE]Если игрок становится союзником города-государства, он получает дополнительные бонусы, связанные с особенностью этого города-государства, а также все роскошные и стратегические ресурсы, которые город-государство подключил.'
