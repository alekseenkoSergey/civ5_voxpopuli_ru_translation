...
-- Ban Luxury
UPDATE Language_ru_RU
SET Text = 'Роскошный ресурс объявляется аморальным, исчезающим или иным образом неприемлемым для использования населением. Пока действует запрет, цивилизации не получают от этого роскошного ресурса ни [ICON_HAPPINESS_1] счастья, ни бонусов монополии.'
