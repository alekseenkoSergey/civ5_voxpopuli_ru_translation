...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Маре Нострум[ENDCOLOR]: +1 [ICON_RES_OIL] нефти и [ICON_RES_COAL] угля за каждый союз с городом-государством. +2 [ICON_PRODUCTION] производства и [ICON_CULTURE] культуры атоллам, рыбацким лодкам и морским нефтяным платформам. Морские дальнобойные юниты получают повышение [COLOR_POSITIVE_TEXT]Mare Nostrum[ENDCOLOR].'
WHERE Tag = 'TXT_KEY_POLICY_NATIONALISM_HELP';

UPDATE Language_ru_RU
SET Text = 'Mare Nostrum, то есть «Наше море», — выражение, обозначавшее контроль Римской империи над всем Средиземноморским бассейном. После объединения Италии этот термин стал лозунгом итальянской экспансии и «возвращения» земель, подобающих истинным наследникам Рима.'
